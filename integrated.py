...
df.drop(['Comment','Neg_Count','Unique_words','Pro_Count', 'Pre_Count', 'Con_Count', 'Art_Count','Nega_Count', 'Aux_Count','Count Reviews','detect','Rate','Date'], axis=1, inplace=True)
